...
*/
var customName  = document.getElementById("customname"); // because it has an ID
var randomize = document.querySelector(".randomize");  // because it a class
var story = document.querySelector(".story"); // because it a class
...
/* STEP 2: have a look at the following function - if you call this function and pass it an array, it will return one of the 
